...
@Table(
    ...
    uniqueConstraints = [
        UniqueConstraint(
            name = "uk_message_room_post_members",
            columnNames = ["post_id", "member_id_1", "member_id_2"]
        )
    ],
    indexes = [
        Index(name = "idx_message_room_member1", columnList = "member_id_1"),
        Index(name = "idx_message_room_member2", columnList = "member_id_2")
    ]
)
class MessageRoom(
    @Id
